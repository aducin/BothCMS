...
<head>
	...
	#tagText{
		...
		border: 2px ridge purple;font-style: italic;}
	#quantityText{
	margin-bottom: 11px;margin-left:144px;
	}
	#conditionText{
	margin-bottom: 11px;margin-left:160px;
	}
	#authorText{
	margin-bottom: 11px;margin-left:284px;
	}
	#priceText{
		margin-bottom: 11px;margin-left:44px;
	}
	#priceTextO{
...
background-color: silver;border: 2px ridge black;font-style: italic; font-size: 15px;}
	...
	#textarea{
		border: 1px ridge brown;width: 624px;display: block;
	}
	</style>
